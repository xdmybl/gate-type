...
func CaCertificateClientFromClientsetProvider(clients gate_v1.Clientset) gate_v1.CaCertificateClient {
	return clients.CaCertificates()
}

// Provider for CaCertificate Client from Client
func CaCertificateClientProvider(client client.Client) gate_v1.CaCertificateClient {
	return gate_v1.NewCaCertificateClient(client)
}

type CaCertificateClientFactory func(client client.Client) gate_v1.CaCertificateClient

func CaCertificateClientFactoryProvider() CaCertificateClientFactory {
	return CaCertificateClientProvider
}

type CaCertificateClientFromConfigFactory func(cfg *rest.Config) (gate_v1.CaCertificateClient, error)

func CaCertificateClientFromConfigFactoryProvider() CaCertificateClientFromConfigFactory {
	return func(cfg *rest.Config) (gate_v1.CaCertificateClient, error) {
...
func SslCertificateClientFromClientsetProvider(clients gate_v1.Clientset) gate_v1.SslCertificateClient {
	return clients.SslCertificates()
}

// Provider for SslCertificate Client from Client
func SslCertificateClientProvider(client client.Client) gate_v1.SslCertificateClient {
	return gate_v1.NewSslCertificateClient(client)
}

type SslCertificateClientFactory func(client client.Client) gate_v1.SslCertificateClient

func SslCertificateClientFactoryProvider() SslCertificateClientFactory {
	return SslCertificateClientProvider
}

type SslCertificateClientFromConfigFactory func(cfg *rest.Config) (gate_v1.SslCertificateClient, error)

func SslCertificateClientFromConfigFactoryProvider() SslCertificateClientFromConfigFactory {
	return func(cfg *rest.Config) (gate_v1.SslCertificateClient, error) {
		clients, err := gate_v1.NewClientsetFromConfig(cfg)
		if err != nil {
			return nil, err
		}
